...
void main(void)
{
    ...
    I2C1_Write1ByteRegister(0x0E, 0x1B, 0b01000000);
    I2C1_Write1ByteRegister(0x0E, 0x1B, 0b01000010);
    I2C1_Write1ByteRegister(0x0E, 0x1B, 0b11000010);
    ...
    while (1)
    {
        ...
        data = I2C1_Read1ByteRegister(0x0E, 0x16);
        data = data + 1;
        data = I2C1_Read1ByteRegister(0x0E, 0x17);
        data = data + 1;
        data = I2C1_Read1ByteRegister(0x0E, 0x18);
        data = data + 1;
        data = I2C1_Read1ByteRegister(0x0E, 0x1A);
        data = data + 1;
